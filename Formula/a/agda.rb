class Agda < Formula
  ...
  stable do
    ...
    resource "agda-language-server" do
      url "https://github.com/agda/agda-language-server/archive/refs/tags/dev.tar.gz"
      sha256 "412116dc4e947e5304e3cd52f037ccb80477a23682c7a4c9981ab234a2b44b4c"

      # TODO: remove when version is bumped
      patch do
        url "https://github.com/agda/agda-language-server/commit/14f08472630ccd8e391d7184651dcdd5a96366d4.patch?full_index=1"
        sha256 "d9b533ec24fd80ab43b2b4304e60ae3015bacd0b11e712717472dfe21f0a1b46"
      end
    end
  end
  ...
  test do
    ...
    assert_equal "Agda v2.7.0.1 Language Server v6", shell_output("#{bin}/als -V").strip
  end
end
__END__
