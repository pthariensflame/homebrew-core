class Agda < Formula
  ...
  stable do
    ...
    resource "agda-language-server" do
      ...
      sha256 "f6697cc20d2fc1c16eafdbcd5bf64ddade7552f2d473f5f08ff82bc9bd9f79c3"

      # TODO: remove when version is bumped
      patch do
        url "https://github.com/agda/agda-language-server/commit/da2495f0975f70a484f752c499e7561141be8fdb.patch?full_index=1"
        sha256 "b6ed634a7f96680e5dcc008a1556279dc61c58628444246f265d6943f3f6bbec"
      end
    end
  end
